...
const offerings = [
    ...
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
        description: "On-demand cleaning & treatment"
    },
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
    ...
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
        description: "Dress upgrades and donations"
    },
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
...
const eligibleItems = [
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
        description: "Full dress sets"
    },
    {
        icon: <Ionicons name="ios-checkmark-sharp" size={20} color={colors.panel1} />,
        description: "Related outfit items"
    }
]

function DressPackage(props) {
    return (
        <>
